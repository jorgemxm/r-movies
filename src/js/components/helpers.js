...
class Helpers {
    ...
    // Format time-length
    //--------------
    static formatMovieDuration( runtime ) {
        return moment
    ...
    static imagify( Poster ) {
        ...
        //--------------
        let path = '/img/movies-posters/';
        let poster = Poster.replace(/https:\/\/images-na.ssl-images-amazon.com\/images\/M\//, '' );
        // let ext = '.jpg';
...
//-----------------------------------
// POC:
// It Replaces Special Characteres from the string with regular [a-z] characters
...
String.prototype.latinise = function() {
    return this.replace(/[^A-Za-z0-9\[\] ]/g, function(char) {
        return Latinise.latin_map[char] || char
    })
};
